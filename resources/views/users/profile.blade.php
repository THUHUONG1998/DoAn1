                                                    ...
                                                    <div class="tab-pane active" id="tab_1_1">
                                                        <form action="{{route('update-profile')}}" method="POST">
                                                            <div class="form-group">
                                                                ...
                                                                <input name ="username" type="text" placeholder="User Name" class="form-control" /> </div>
                                                            <div class="form-group">
                                                                <label class="control-label">Họ và tên</label>
                                                                <input name ="hovaten" type="text" placeholder="Họ và tên" class="form-control" /> </div>
                                                            <div class="form-group">
                                                                <label class="control-label">Email</label>
                                                                <input name= "email" type="email" placeholder="Email" class="form-control" /> </div>
                                                            <div class="form-group">
                                                                <label name = "diachi" class="control-label">Địa chỉ</label>
                                                                <input type="text" placeholder="Địa chỉ" class="form-control" /> </div>
                                                            <div class="form-group">
                                                                <label name= "danhso" class="control-label">Danh số</label>
                                                                <input type="text" placeholder="Danh số" class="form-control" /> </div>
                                                            <div class="form-group">
                                                                <label name= "danhso" class="control-label">Danh số</label>
                                                                <input type="text" placeholder="Danh số" class="form-control" /> </div>
                                                                <div class="form-group">
